...
function videoVolume(){
		var vid = document.getElementById("video");
			if( vid.muted ){
				vid.muted = false;
				vid.volume = 0.5;
				document.getElementById("liga_som").style.display = 'none';
				document.getElementById("desliga_som").style.display = 'block';
			}else{
				vid.muted = true;
				document.getElementById("liga_som").style.display = 'block';
				document.getElementById("desliga_som").style.display = 'none';
			}
		}
